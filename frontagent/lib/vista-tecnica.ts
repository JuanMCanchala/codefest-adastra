 ...
 *
 * La consola la revisa un oficial que juzga si el sistema responde con rigor y cita bien, no
 * el equipo que la construyó. El consumo de tokens, los modelos, la ruta interna del
 * orquestador y los parámetros de las herramientas no le sirven para eso y compiten con la
 * evidencia. Siguen a un clic de distancia, no en la vista principal.
 *

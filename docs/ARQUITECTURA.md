# Arquitectura del sistema — Reto 1

**Equipo AeroCode · CODEFEST AD ASTRA 2026 · Final (Etapa 2).**

Documento de arquitectura exigido en la §1.4 de la especificación oficial. Cubre
...
flowchart LR
    ...
    O --> D
    D -- corpus/ambos --> C["agente de corpus<br/>1 llamada"]
    D -- visualizacion --> V["agente de visualización<br/>1 llamada"]
...
## 8. Límites conocidos y pendientes declarados

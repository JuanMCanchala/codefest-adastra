...
export const CATALOGO: readonly DefinicionComponente[] = [
  ...
  },
  {
    ...
    etiqueta: "Población orbital",
    descripcion:
      "Crecimiento de la población en órbita, desechos de ensayos antisatélite, satélites de Colombia y satélites de inspección o proximidad (Luch, GSSAP, Kosmos), según el catálogo GCAT. Cubre F2, el único fenómeno sin componente propio.",
    familia: "temporal",
    icono: Orbit,
    usaAnios: true,
    filtros: [
      {
        ...
        etiqueta: "Vista",
        tipo: "opciones",
        predeterminado: "crecimiento",
        opciones: [
          { valor: "crecimiento", etiqueta: "Crecimiento" },
          { valor: "asat", etiqueta: "Ensayos antisatélite" },
          { valor: "colombia", etiqueta: "Satélites de Colombia" },
          { valor: "inspectores", etiqueta: "Satélites de inspección" },
        ],
      },
      { clave: "pais", etiqueta: "País (código GCAT)", tipo: "texto", ayuda: "p. ej. CN, US, RU" },
      {
        clave: "top",
        etiqueta: "Ensayos (máximo)",
        tipo: "numero",
        minimo: 3,
        maximo: 26,
        predeterminado: 10,
